<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tenants.aspx.cs" Inherits="HouseRentalMS.Tenants" %>
    ...
    <form id="form1" runat="server">
        <div style="height: 555px">
            <table class="auto-style1" style="padding: 10px; background-color: #004aad;">
                <tr>
                    <td class="auto-style2" style="margin: 0px;">
                        <asp:Label ID="Label15" runat="server" ForeColor="White" Text="House Rental MS" CssClass="auto-style-logo "></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="margin: 0px;" class="auto-style5"></td>
                </tr>
                <tr>
                    <td class="auto-style6" style="margin: 0px"></td>
                </tr>
                <tr>
                    <td class="auto-style7" style="margin: 0px">
                ...
                <tr>
                    <td class="auto-style26" style="margin: 0px">
                ...
                <tr>
                    <td class="auto-style4" style="margin: 0px"></td>
                </tr>
                <tr>
                    <td class="auto-style2" style="margin: 0px">&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style25" style="margin: 0px"></td>
                </tr>
                <tr>
                    <td class="auto-style2" style="margin: 0px">
            ...
            <table class="auto-style8" style="background-color: #000000">
                ...
                <tr>
                    ...
                    <td class="auto-style28">
                        <asp:Label ID="Label17" runat="server" CssClass="auto-style-logo" ForeColor="White" Text="Tenants"></asp:Label>
                    </td>
            ...
            <table class="auto-style12">
                ...
                <tr>
                    ...
                    <td class="auto-style17">
                        <asp:TextBox ID="TNameTb" runat="server" Height="24px" Width="244px"></asp:TextBox>
                    </td>
            ...
            <table class="auto-style12">
                <tr>
                    ...
                    <td style="font-size: 25px">
                        <asp:Label ID="Label21" runat="server" BorderStyle="None" CssClass="list-heading" Text="Tenants List"></asp:Label>
                    </td>
                </tr>
            </table>
            &nbsp;
            <asp:GridView ID="TenantsDGV" runat="server" CssClass="auto-style24" Height="219px" Width="1013px" AutoGenerateSelectButton="True" OnSelectedIndexChanged="TenantsDGV_SelectedIndexChanged">
